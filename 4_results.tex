...
For the difference in the number of authors, projects in C/C++ have an odds 
ratio below 1 showing they are about 6\%  (Odds Ratio = 0.94) less 
likely to see increased
authorship after transitioning from restrictive to permissive licenses
compared to permissive to restrictive shifts.
Conversely, projects using Go show an odds ratio just over 1, approximately 
6.6\% greater odds of increasing authorship following a restrictive to 
permissive license change.
Although modest in magnitude, these odds ratios represent clear 
language-specific differences in community response to licensing shifts.

Regarding the difference in the number of blobs, the odds ratio for C/C++ 
projects is considerably lower than 1, indicating that projects shifting 
from restrictive to permissive licenses are about 32\% less likely to
experience growth in repository blobs compared to those shifting in 
the opposite direction. Python projects, however, exhibit an odds 
ratio substantially greater than 1, suggesting a 52\% higher likelihood 
of increased repository growth after adopting permissive licenses.
The substantial magnitude of these odds ratios highlights a strong 
practical influence of license directionality in these languages.

In the difference in the number of commits, only C/C++ projects show 
a significant result, with an odds ratio clearly below 1, meaning 
there's approximately a 21\% lower chance of increased commit 
frequency when transitioning to a permissive license compared to the 
reverse direction. This moderate odds ratio underscores a meaningful
practical reduction in development activity following permissive
licensing within C/C++ communities.

For the difference in the number of files, the general restrictive to 
permissive license change has an odds ratio of approximately 1.30, 
indicating about 30\% higher odds of increased file counts. However, 
this general positive effect is significantly weakened in C/C++ projects,
which show an odds ratio notably below 1, meaning these projects are 
31\% less likely to experience such growth. On the other hand, 
PHP and Python exhibit odds ratios above 1 (approximately 1.13 and 
1.55, respectively), indicating PHP projects have about 13\% greater 
odds and Python projects have about 55\% greater odds of increased 
file counts following a shift to permissive licenses.

Concerning the difference in active months, C/C++ projects demonstrate
an odds ratio slightly below 1, suggesting approximately an 8\% reduced
likelihood of sustained project activity after a restrictive to 
permissive license transition. Python projects have an odds ratio 
slightly above 1, indicating about 8\% greater odds of maintaining 
longer periods of active development under permissive licenses. 
While modest, these differences clearly show distinct patterns by language.

Regarding the difference in upstream projects, the general restrictive 
to permissive license transition effect shows about 25\% greater odds
of increased reusing from upstream projects. The interactions reveal 
language-specific nuances: for C/C++ and Ruby, the odds ratios are 
significantly less than 1 (approximately 0.85 each), suggesting 
about 15\% lower odds of increased upstream integration after moving
to permissive licenses. Conversely, PHP and especially Python 
projects demonstrate greater odds (approximately 1.36 and 1.37 
respectively), indicating 36\% to 37\% increased likelihood of
reusing from other projects after adopting permissive licenses.

In the case of difference in downstream projects, the general restrictive 
to permissive transition shows an odds ratio slightly greater than 1,
reflecting about 9–10\% greater odds of increased downstream project
use or integration following a shift to permissive licenses.
This moderate effect indicates a practical tendency toward greater
popularity or usage within broader software ecosystems under
permissive licensing conditions.

Lastly, for the difference in burstiness, the odds ratios show 
moderate yet meaningful language-specific impacts. Projects using
C/C++ have about 7\% greater odds of experiencing more intense 
bursts of activity after adopting permissive licenses. Similarly,
PHP shows about a 3.5\% increased odds. However, Python projects 
show reduced odds, meaning they are about 7\% less likely to 
experience bursty activity after permissive license adoption. 
Although moderate, these odds ratios highlight distinct behavioral 
differences tied directly to licensing directionality.
